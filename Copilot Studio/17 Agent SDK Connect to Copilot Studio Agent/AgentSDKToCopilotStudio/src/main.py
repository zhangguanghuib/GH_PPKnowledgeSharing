...
from microsoft_agents.activity import Activity, ActivityTypes, StreamInfo
...
def allow_missing_stream_sequence():
    StreamInfo.model_fields["stream_sequence"].default = 0
    StreamInfo.model_rebuild(force=True)
    Activity.model_rebuild(force=True)


allow_missing_stream_sequence()
